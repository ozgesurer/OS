...
My dissertation develops new methods to discover group structure from high-dimensional data to address various problems in big-data environments. To discover the group structure, my dissertation proposes a new algorithm, ***coefficient tree regression***, that fits regression models in a fundamentally different way. 
